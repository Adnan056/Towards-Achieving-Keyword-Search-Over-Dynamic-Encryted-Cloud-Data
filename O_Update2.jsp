...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style8">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style10"> Updated <strong>Block</strong> !!! </h2>
...
%>
          ...
          <form action="O_Update3.jsp" method="post">
            <table width="598" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="286" height="34" bgcolor="#FF0000"><span class="style4 style9"><strong>File Name :- </strong></span></td>
                <td width="356"><input name="file" type="text" id="t42" size="35"
			value="<%= file %>" readonly="readonly" /></td>
              </tr>
              <tr>
                <td width="286" height="32" bgcolor="#FF0000"><span class="style4 style9"><strong>
Block                  :</strong></span></td>
			...
			value="<%= block %>" readonly="readonly" />
              ...
              <tr>
                <td height="257" bgcolor="#FF0000"><span class="style9"></span></td>
                <td><textarea name="cont" cols="50" rows="15" readonly="readonly"><%= encryptedValue%></textarea></td>
              </tr>
              <tr>
                <td height="35" bgcolor="#FF0000"><span class="style9 style4"><strong>MAC: </strong></span></td>
