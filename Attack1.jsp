    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
		  ...
		  <li><a href="Kgc_Login.jsp"></a></li>
          <li><a href="C_Login.jsp">CLOUD</a></li>
        </ul>
      </div>
      <div class="logo">
        <h1 class="style7">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
...
<tr><td width="100" align="center" bgcolor="#FF0000"><span class="style10">User Name</span></td>
<td width="437"><input type="text" value="<%=aname%>"  name="aname"/> </td></tr>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><span class="style6"><a href="D_Login.jsp"></a></span></li>
          </ul>
        </div>
        <div class="gadget">
          <h2 class="star"><br />
