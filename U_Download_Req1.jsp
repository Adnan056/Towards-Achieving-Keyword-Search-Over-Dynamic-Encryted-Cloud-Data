...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style29">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2 class="style30">Request Private Key Permission  </h2>
            <p class="infopost">&nbsp;</p>
            <p>
              <%
			  ...
			  try 
			  {
				...
				if ( rs1.next())
				{
					...
					if(download_per.equalsIgnoreCase("Requested"))
					{
						...
						<p class="style27">Request Already Sent To Owner!! </p>
						<p class="style31"><a href="U_Main.jsp" class="style28">Back</a></p>
						<p class="style31">
						<%	
					}
				...
				else
				{
					...
					if ( rs2.next())
					{
						...
						if(rs4.next())
						{
							...
							<p class="style27">Request Sent To Owner !! </p>
							<p class="style31"><a href="U_Main.jsp" class="style28">Back</a></p>
							<p class="style31">
							<%
						}
