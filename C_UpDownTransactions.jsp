...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style23">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style24"> Upload &amp; Download Transactions !!! </h2>
          <p class="infopost">&nbsp;</p>
          <table width="565" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
            <tr>
              <td width="45" height="31" bgcolor="#FF0000"><div align="center" class="style25"> ID </div></td>
              <td width="117" bgcolor="#FF0000"><div align="center" class="style25">User Name </div></td>
              <td width="109" bgcolor="#FF0000"><div align="center" class="style25">File Name </div></td>
              <td width="116" bgcolor="#FF0000"><div align="center" class="style25">Task</div></td>
              <td width="164" bgcolor="#FF0000"><div align="center" class="style25">Date &amp; Time</div></td>
            </tr>
            <%
