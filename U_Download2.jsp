			...
			if(maac1.equalsIgnoreCase("Shared"))
			{
				...
				if(rs12.next())
				{
					...
					else 
					{
						...
						<h3 class="style24 style26">Trapdoor / Secret Key Mismatch / PK Not Generated!!!</h3>
						</p>
						<br />
						<%
					}
				...
				{
					%>
					<h3 class="style27">File Doesn't Exist !!!</h3>
					</p>
					<br />
					<%
				}
			...
			else
			{
				...
				if(rs1.next())
				{
					...
					else 
					{
						...
						<h3 class="style27">Trapdoor / Secret Key Mismatch / PK Not Generated!!!</h3>
						</p>
						<br />
						<%
					}
