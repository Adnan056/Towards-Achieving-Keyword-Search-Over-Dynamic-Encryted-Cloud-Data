...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style25">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
		...
		String cloud = "cloud";
			...
			if (!(rs3.next()==true))
			{
				...
				st1.executeUpdate("insert into  results values ('"+file+"','"+ttime+"','"+tpt+"')"); 
					...
					<p> </p>
					<h2 class="style26">Data Uploaded Successfully !!!</h2>
					</p>
					<br />
					<div class="clr"></div>
					<%
			...
			<h2 class="style26">Data Already Exists Already !!!</h2>	
			<%}
