...
.style35 {color: #3f3f3f; font-size: 12px; font-weight: bold; }
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style30">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2 class="style36"> Download Permission Response </h2>
            <form id="form" name="form1" method="post" action="U_finddownper.jsp">
              <div align="center" class="style29">
                <p align="left" class="style20">&nbsp;</p>
                <p align="left" class="style20">&nbsp;</p>
                <p align="left" class="style31"><span class="style28">Enter Owner Name:</span>
                    <input required="required" name="t42" type="text" size="30" />
                </p>
                <p align="left"><span class="style32"> Enter File Name : &nbsp;&nbsp;&nbsp;</span><span class="style35"></span><span class="style23">&nbsp;</span>
