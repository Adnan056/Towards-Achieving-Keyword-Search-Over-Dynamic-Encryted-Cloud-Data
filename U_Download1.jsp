...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style25">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
	...
	try 
	{
		...
		if (rs1.next()) 
		{
			...
			{
				%>
				<h3 class="style25">Wait For Cloud To Grant Private Key Permission !!!</h3>
				<%
			}
				...
				if(rs.next()==true)
				{
					...
					if(mac1.equalsIgnoreCase("Shared"))
					{
						...
						if(rs2.next()==true)
						{
							...
							<tr>
							<td width="223" bgcolor="#FF0000"><span class="style1 style27"><strong>Enter File Name :</strong></span></td>
							<td width="245"><label>
							...
							<tr>
							<td height="34" bgcolor="#FF0000"><span class="style1 style27"><strong>Enter Owner Name :</strong></span></td>
							<td><input name="oname" type="text" size="40" value="<%=oname1%>" /></td>
							</tr>
							<tr>
							<td height="34" bgcolor="#FF0000"><span class="style1 style27"><strong>MAC 1 :</strong></span></td>
							<td><input name="t12" type="text" size="40" value="<%=mac11%>" /></td>
							</tr>
							<tr>
							<td height="34" bgcolor="#FF0000"><span class="style1 style27"><strong>MAC 2 :</strong></span></td>
							<td><input name="t122" type="text" size="40" value="<%=mac22%>" /></td>
							</tr>
							<tr>
							<td height="34" bgcolor="#FF0000"><span class="style1 style27"><strong>MAC 3 :</strong></span></td>
							<td><input name="t123" type="text" size="40" value="<%=mac33%>" /></td>
							</tr>
							<tr>
							<td height="34" bgcolor="#FF0000"><span class="style1 style27"><strong>MAC 4 :</strong></span></td>
							<td><input name="t124" type="text" size="40"value="<%=mac44%>" /></td>
							</tr>
							<tr>
							<td bgcolor="#FF0000"><span class="style27 style1"><strong>Secret Key :</strong></span></td>
					...
					else
					{
						...
						<tr>
						<td bgcolor="#FF0000"><span class="style1 style27"><strong>Secret Key :</strong></span></td>
		...
		{
			%>
			<h3 class="style24 style26">You Have Not Requested For Download Permission<br /> <a href="U_Download_Req.jsp">Click Here</a> To Request !!!</h3>
			<%
		}
