  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>User Login </h2>
          <p class="infopost"><img src="images/Login.png" width="216" height="113" /></p>
          <div class="style2"></div>
          <form action="U_Authentication.jsp" method="post" id="leavereply">
            ...
            <p><span class="style4">New User? click here to</span> <a href="U_Register.jsp"> Register</a></p>
            <p><a href="index.html">Back</a><br /> 
            </p>
          </form>
