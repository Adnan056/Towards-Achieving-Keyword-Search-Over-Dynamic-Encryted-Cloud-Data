...
.style13 {font-size: 14px; color: #FFFF00; font-weight: bold; }
.style14 {
	color: #FFFF00;
	font-weight: bold;
}
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style10">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style11"> Update File </h2>
          <p class="infopost style4 style11"><em>Select blocks of perticular files and update its contents. </em></p>
          <form id="form1" name="form1" method="post" action="O_Update1.jsp">
            ...
            <table width="576" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="183" height="38" bgcolor="#FF0000"><span class="style13">Enter File Name :</span></td>
                <td width="415" bgcolor="#FF0000"><input name="file" type="text" id="file" size="50" required="required" /></td>
              </tr>
              <tr>
                <td height="38" bgcolor="#FF0000" class="style13">Select The Block : </td>
                <td bgcolor="#FF0000"><span class="style14">
                  <select name="block"  >
