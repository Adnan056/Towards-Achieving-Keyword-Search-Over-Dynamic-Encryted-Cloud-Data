...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style21">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
          ...
          <div class="article">
            ...
            <p class="infopost">
              <%
				...
				String query="select * from user where name='"+name+"' ";//and status!='Requested'";
            ...
            <form id="form1" method="post" action="U_Search1.jsp">
              ...
              <p align="left"> <a href="U_Search_Req.jsp" class="style20"> View Search Permission Response</a></p>
            </form>
            <%
				 	}
				}
