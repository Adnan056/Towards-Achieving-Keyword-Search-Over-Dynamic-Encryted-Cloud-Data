  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2 class="style25">Download  Files !!!  </h2>
            <p class="infopost">&nbsp;</p>
            <form action="U_Download1.jsp" method="post" name="form1" id="form1">
              <table width="490" border="0" align="center">
                <tr>
                  <td width="160" height="35" bgcolor="#FF0000"><span class="style1 style26"><strong>Enter File Name :-</strong></span></td>
                  <td width="308"><label>
			...
			type="text"  size="40" />
                ...
                <tr>
                  <td height="34" bgcolor="#FF0000"><span class="style1 style26"><strong>MAC2:-</strong></span></td>
                  <td><input name="t122" type="text" size="40" /></td>
                </tr>
                <tr>
                  <td height="34" bgcolor="#FF0000"><span class="style1 style26"><strong>MAC3:-</strong></span></td>
