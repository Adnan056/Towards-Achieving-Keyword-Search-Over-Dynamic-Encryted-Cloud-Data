  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2 class="style22">Request Private Key Permission !!!  </h2>
            <p class="infopost">&nbsp;</p>
            <form id="form" name="form1" method="post" action="U_Download_Req1.jsp">
              <a href="U_DownPerRes.jsp"> View Private Key Permission Response </a>
              <p>&nbsp;</p>
              <div align="center">
                <p align="left" class="style17"><span class="style21">Enter Owner Name :&nbsp;
                    <input name="t142" type="text" size="30" />
                </span></p>
                <p align="left" class="style17"> <span class="style21">Enter File Name :</span>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
            ...
            <p class="infopost"><a href="U_Main.jsp">Back</a></p>
            <div class="style2"></div>
            <div class="img">
