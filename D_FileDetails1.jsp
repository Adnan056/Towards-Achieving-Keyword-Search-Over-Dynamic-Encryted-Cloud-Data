...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3 style27">Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</h1>
      </div>
...
try 
	{
			...
			value="<%= s3 %>" size="50" readonly="readonly" />
                </div></td>
              </tr>
			...
			value="<%= s4 %>" size="50" readonly="readonly" />
                </div></td>
              </tr>
			...
			value="<%= s6 %>" size="50" readonly="readonly" />
              ...
              <tr>
                <td height="30" bgcolor="#FF0000"><div align="center" class="style28"><strong>Secret Key : </strong></div></td>
                <td><div align="center">
                    <%
					if(s7.equals("Generate"))
					{%>
					<a href="GeneratePKey.jsp?uid=<%=i%>&fname=<%=s2%>">Generate Key </a>
					<%
					}
					else
					{%>
