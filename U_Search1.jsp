  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2 class="style30">Search Files !!!  </h2>
            <p class="infopost">&nbsp;</p>
...
if((decryptedValue1.toLowerCase().contains(keyword))||(decryptedValue2.toLowerCase().contains(keyword))||(decryptedValue3.toLowerCase().contains(keyword))||(decryptedValue4.toLowerCase().contains(keyword))||(fname.toLowerCase().contains(keyword)))
					{
						found=found+1;
