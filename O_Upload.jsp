...
<div class="main">
  ...
  <div class="content style1">
	...
	{			
						...
						<td width="286" height="35" bgcolor="#FF0000"><span class="style24 style4">Select File :- </span></td>
						<td width="356"><input required="required" type="file" name="t42" id="file"  onchange="loadFileAsText()" /></td>
						</tr>
						<tr>
						<td height="35" bgcolor="#FF0000" class="style24 style4">File Name :- </td>
						<td><input required="required" name="tt" type="text" id="t42" size="50"/></td>
						</tr>
						<tr>
						<td height="255" bgcolor="#FF0000">&nbsp;</td>
