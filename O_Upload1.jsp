...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style23 style21"><strong>Towards Achieving Keyword Search over Dynamic Encrypted Cloud Data with Symmetric-Key Based Verification</strong></h1>
      </div>
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style23">Upload File !!! </h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          <span class="style23">
          <% try 
...
<input type="hidden" name="fsize" value="<%=sourceFileSize %>" />
  <table width="560" border="0" align="center">
    <tr><input type="hidden" name="start" value="<%=start%>" />
      <td width="143" height="39" bgcolor="#FF0000"><span class="style4 style24">File Name :- </span></td>
      <td width="407"><input name="t42" type="text" id="t42"
			value="<%= file %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style4 style24">Block-1 </span></td>
      <td width="407"><span class="style4 style22">Size:<%=a1%>Bytes</span></td>
    </tr>
    <tr>
      <td height="145" bgcolor="#FF0000"><span class="style24"></span></td>
      <td>
        <textarea name="text1" cols="50" rows="8" readonly="readonly"><%= encryptedValue1 %></textarea>      </td>
    </tr>
    <tr>
      <td height="40" bgcolor="#FF0000"><span class="style4 style24">MAC-1: </span></td>
      <td><input name="t1" type="text" id="t4"
			value="<%= h[1] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="41" bgcolor="#FF0000"><span class="style4 style24">Block-2 </span></td>
      <td width="407"><span class="style4 style22">Size:<%=(a2-a1)%>Bytes</span></td>
    </tr>
    <tr>
      <td bgcolor="#FF0000"><span class="style24">></span></td>
      <td>
        <textarea name="text2" cols="50" rows="8" readonly="readonly"><%= encryptedValue2 %></textarea>      </td>
    </tr>
    <tr>
      <td height="37" bgcolor="#FF0000"><span class="style4 style24">MAC-2: </span></td>
      <td><input name="t2" type="text" id="t4"
			value="<%= h[2] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style4 style24">Block-3 </span></td>
      <td width="407"><span class="style4 style22">Size:<%=(a3-a2)%>Bytes</span></td>
    </tr>
    <tr>
      <td height="168" bgcolor="#FF0000"><span class="style24"></span></td>
      <td>
        <textarea name="text3" cols="50" rows="8" readonly="readonly"><%= encryptedValue3 %></textarea>      </td>
    </tr>
    <tr>
      <td height="41" bgcolor="#FF0000"><span class="style4 style24">MAC-3: </span></td>
      <td><input name="t3" type="text" id="t4"
			value="<%= h[3]%>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="35" bgcolor="#FF0000"><span class="style4 style24">Block-4 </span></td>
      <td width="407"><span class="style4 style22">Size:<%=(a4-a3)%>Bytes</span></td>
    </tr>
    <tr>
      <td height="161" bgcolor="#FF0000"><span class="style24"></span></td>
      <td>
        <textarea name="text4" cols="50" rows="8" readonly="readonly"><%= encryptedValue4 %></textarea>      </td>
    </tr>
    <tr>
      <td height="42" bgcolor="#FF0000"><span class="style4 style24">MAC-4: </span></td>
