...
<div class="main">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style10"> Update File !!! </h2>
		...
		String block = request.getParameter("block");
          ...
          <form id="form1" name="form1" method="post" action="O_Update2.jsp">
            <table width="598" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="286" height="31" bgcolor="#FF0000"><span class="style4 style9"><strong> File Name :</strong></span></td>
                <td width="356"><input required="required" type="text" name="file" id="file" value="<%=file%>" size="50" /></td>
              </tr>
              <tr>
                <td height="38" bgcolor="#FF0000" class="style7 style4"><span class="style9"><strong>  Block : </strong></span></td>
                <td width="356"><input required="required" type="text" name="block" id="file" value="<%=block%>" size="50" /></td>
              </tr>
              <tr>
                <td height="257" bgcolor="#FF0000" class="style7 style4"><span class="style9"><strong>Block Contents : </strong></span></td>
