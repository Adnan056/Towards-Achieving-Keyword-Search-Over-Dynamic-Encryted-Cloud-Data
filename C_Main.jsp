        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="C_SearchReq.jsp">Search Requests</a></strong></li>
			 <li><strong><a href="C_Attacker.jsp">View Attackers</a></strong></li>
			...
			<li><strong><a href="C_Throughput.jsp">View Throughput Results</a></strong></li>
			 <li><strong><a href="D_CpuSpeed.jsp">CPU Speed </a></strong></li>
